package com.project.MavenProject.webTables;
...
public class WebCalendarFunction {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		driver.findElement(By.xpath("(//div[@class='picker-label'])[1]")).click();
	
		Thread.sleep(8000);
		String date="4-November 2019";
